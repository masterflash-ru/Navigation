...
class Breadcrumbs extends AbstractHelper 
{
    ...
    protected $_default=[
        "zf3"=>[/*стандартные параметры для встроенного в ZF3 генератора меню*/
            ...
            "LinkLast"=>false,              //вывод последнего элемента
        ...
        "bootstrap4"=>[
            "locale"=>"ru_RU",               //имя локали
            "LinkLast"=>false,              //вывод последнего элемента
            "Separator"=>'',                //разделитель между элементами (не используется)
            "tpl"=>null,
        ],
    ];
...
public function render(ZFNavigation $navigation,array $options)
{
    ...
    $nav =$nav->breadcrumbs($navigation)
        ->setLinkLast($options["LinkLast"])
